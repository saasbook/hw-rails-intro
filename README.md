...
* Part 0 (A): [Preparation: get RottenPotatoes running locally](part_0_A.md)
* Part 0 (B): [Preparation: deploy to Heroku](part_0_B.md)
* Part 1: [Sort the list of movies (15 points)](part_1.md)
* Part 2: [Filter the list of movies by rating (15 points)](part_2.md)
* Part 3: [Remember the sorting and filtering settings (70 points)](part_3.md)
